...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "ron_fu"
  # spec.authors            = { "ron_fu" => "ron_fu@askey.com" }
  # spec.social_media_url   = "https://twitter.com/ron_fu"
  ...
  spec.source_files  = "FZMSwiftSDK.framework/Headers/*.{h}"
   spec.vendored_frameworks = 'FZMSwiftSDK.framework'
